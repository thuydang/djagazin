...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field placeholders on 'Entry'
        db.create_table('cmsplugin_blog_entry_placeholders', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['cmsplugin_blog.entry'], null=False)),
            ('placeholder', models.ForeignKey(orm['cms.placeholder'], null=False))
        ))
        db.create_unique('cmsplugin_blog_entry_placeholders', ['entry_id', 'placeholder_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field placeholders on 'Entry'
        db.delete_table('cmsplugin_blog_entry_placeholders')
    ...
    models = {
        ...
        'cmsplugin_blog.entry': {
            ...
            'placeholders': ('cmsplugin_blog.models.M2MPlaceholderField', [], {'symmetrical': 'False'}),
