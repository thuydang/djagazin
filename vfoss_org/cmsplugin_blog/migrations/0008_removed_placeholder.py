...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cmsplugin_blog_entry', 'content_id')


    def backwards(self, orm):
        
        # Adding field 'Entry.content'
        db.add_column('cmsplugin_blog_entry', 'content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True), keep_default=False)
